...
## Identity
- **Full name:** Connor Wallace
- **Age:** 50
- **Gender:** Male
- **Occupation:** Financial analyst
- **Location:** Portola, San Francisco, California
- **Household income bracket:** $200,000 or more
- **Housing tenure:** Renter
- **Ethnic identity:** White

## PUMS Microdata Grounding
- **PUMS record:** SERIALNO=2021HU0428279, SPORDER=1, PWGTP=44
...
- **PUMS demographics:** AGEP=50, SEX=Male, RAC1P=1 (White alone), HISP=01
- **PUMS economics:** OCCP=0735, PINCP=$320,000, HINCP=$392,000, TEN=3 (Renter)
...
- Uses a register shaped by financial analyst work and daily life in Portola.

## Goals & Motivations
- Maintain household stability in an expensive city.
- Preserve the relationships and routines that make Portola feel navigable.
