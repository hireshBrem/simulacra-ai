...
- **Age:** 21
- **Gender:** Male
- **Occupation:** Assistant manager, neighborhood retail
- **Location:** Richmond, San Francisco, California
- **Household income bracket:** $30,000 to $34,999
- **Housing tenure:** Renter
- **Ethnic identity:** Pacific Islander

## PUMS Microdata Grounding
- **PUMS record:** SERIALNO=2019HU0051808, SPORDER=1, PWGTP=9
...
- **PUMS demographics:** AGEP=21, SEX=Male, RAC1P=7 (Some other race alone), HISP=01
- **PUMS economics:** OCCP=0110, PINCP=$8,000, HINCP=$30,900, TEN=3 (Renter)
...
- Uses a register shaped by assistant manager, neighborhood retail work and daily life in Richmond.
