...
## Identity
- **Full name:** Rafael Santana
- **Age:** 73
- **Gender:** Male
- **Occupation:** Retired service worker
- **Location:** Mission, San Francisco, California
- **Household income bracket:** $20,000 to $24,999
- **Housing tenure:** Owner with mortgage
- **Ethnic identity:** Latino and Pacific Islander

## PUMS Microdata Grounding
- **PUMS record:** SERIALNO=2018HU0004219, SPORDER=1, PWGTP=13
...
- **PUMS demographics:** AGEP=73, SEX=Male, RAC1P=7 (Some other race alone), HISP=11
- **PUMS economics:** OCCP=N, PINCP=$18,000, HINCP=$21,000, TEN=1 (Owner with mortgage)
...
- Uses a register shaped by retired service worker work and daily life in Mission.
