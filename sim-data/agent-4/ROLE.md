...
- **PUMS record:** SERIALNO=2019HU1367380, SPORDER=1, PWGTP=20
...
- **PUMS demographics:** AGEP=24, SEX=Female, RAC1P=9 (Two or more detailed race groups), HISP=01
- **PUMS economics:** OCCP=1021, PINCP=$140,000, HINCP=$290,000, TEN=3 (Renter)
...
- Uses a register shaped by software engineer work and daily life in Nob Hill.

## Goals & Motivations
- Maintain household stability in an expensive city.
- Preserve the relationships and routines that make Nob Hill feel navigable.
