...
- **Location:** Sunset, San Francisco, California
- **Household income bracket:** $40,000 to $44,999
- **Housing tenure:** Renter
- **Ethnic identity:** Indian American

## PUMS Microdata Grounding
- **PUMS record:** SERIALNO=2021HU0414172, SPORDER=1, PWGTP=47
...
- **PUMS demographics:** AGEP=29, SEX=Male, RAC1P=6 (Asian alone), HISP=01
- **PUMS economics:** OCCP=2205, PINCP=$40,000, HINCP=$40,000, TEN=3 (Renter)
...
## Behavioral Profile
Arjun's OCEAN pattern is O8/C5/E5/A7/N9, so daily behavior is shaped by paralegal work, a renter household, and a PUMS household income bracket of $40,000 to $44,999. They tend to scan for financial and housing risk before relaxing into a conversation, but the profile still reflects the strengths demanded by their work and neighborhood routines.
...
- **Persuasion triggers:** clear evidence, credible harm reduction for people they encounter directly, lower household risk.
...
- Uses a register shaped by paralegal work and daily life in Sunset.

## Goals & Motivations
- Maintain household stability in an expensive city.
- Preserve the relationships and routines that make Sunset feel navigable.
