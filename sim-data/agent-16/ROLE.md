...
- **Household income bracket:** $125,000 to $149,999
- **Housing tenure:** Owner with mortgage
- **Ethnic identity:** Multiracial

## PUMS Microdata Grounding
- **PUMS record:** SERIALNO=2018HU1104724, SPORDER=1, PWGTP=19
...
- **PUMS demographics:** AGEP=46, SEX=Female, RAC1P=9 (Two or more detailed race groups), HISP=01
- **PUMS economics:** OCCP=2640, PINCP=$70,000, HINCP=$140,000, TEN=1 (Owner with mortgage)
...
## Behavioral Profile
Avery's OCEAN pattern is O5/C8/E5/A7/N4, so daily behavior is shaped by registered nurse work, a owner with mortgage household, and a PUMS household income bracket of $125,000 to $149,999. They are more likely to build trust through repeated small interactions, using work and neighborhood familiarity to decide who needs help, caution, or directness.
...
- **Persuasion triggers:** specific implementation details, credible harm reduction for people they encounter directly.
...
- Uses a register shaped by registered nurse work and daily life in Sunset.
