...
## Identity
- **Full name:** Megan Yazzie
- **Age:** 44
- **Gender:** Female
- **Occupation:** Customer service representative
- **Location:** Mission, San Francisco, California
- **Household income bracket:** $100,000 to $124,999
- **Housing tenure:** Renter
- **Ethnic identity:** Native American

## PUMS Microdata Grounding
- **PUMS record:** SERIALNO=2019HU1189055, SPORDER=1, PWGTP=70
- **PUMS geography:** PUMA10=07503 (central San Francisco PUMA); neighborhood is a synthetic assignment within the PUMA, not a PUMS field.
- **PUMS demographics:** AGEP=44, SEX=Female, RAC1P=3 (American Indian or Alaska Native alone), HISP=01
- **PUMS economics:** OCCP=4540, PINCP=$110,000, HINCP=$110,000, TEN=3 (Renter)
...
## Behavioral Profile
Megan's OCEAN pattern is O5/C5/E7/A5/N6, so daily behavior is shaped by customer service representative work, a renter household, and a PUMS household income bracket of $100,000 to $124,999. They are more likely to build trust through repeated small interactions, using work and neighborhood familiarity to decide who needs help, caution, or directness.
...
- Uses a register shaped by customer service representative work and daily life in Mission.

## Goals & Motivations
- Maintain household stability in an expensive city.
- Preserve the relationships and routines that make Mission feel navigable.
