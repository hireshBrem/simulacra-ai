...
## Identity
- **Full name:** Malia Kealoha
- **Age:** 50
- **Gender:** Male
- **Occupation:** Protective service supervisor
- **Location:** Excelsior, San Francisco, California
- **Household income bracket:** $200,000 or more
- **Housing tenure:** Owner free and clear
- **Ethnic identity:** Pacific Islander and Latino

## PUMS Microdata Grounding
- **PUMS record:** SERIALNO=2018HU0159072, SPORDER=1, PWGTP=34
...
- **PUMS demographics:** AGEP=50, SEX=Male, RAC1P=5 (Other Pacific Islander alone), HISP=02
- **PUMS economics:** OCCP=3323, PINCP=$185,000, HINCP=$335,000, TEN=2 (Owner free and clear)
...
- Uses a register shaped by protective service supervisor work and daily life in Excelsior.

## Goals & Motivations
- Maintain household stability in an expensive city.
- Preserve the relationships and routines that make Excelsior feel navigable.
