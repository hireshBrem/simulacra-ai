...
- **Age:** 68
- **Gender:** Male
- **Occupation:** Health technologist
- **Location:** Bayview, San Francisco, California
- **Household income bracket:** $25,000 to $29,999
- **Housing tenure:** Renter
- **Ethnic identity:** White

## PUMS Microdata Grounding
- **PUMS record:** SERIALNO=2018HU0049059, SPORDER=1, PWGTP=10
- **PUMS geography:** PUMA10=07504 (south/southeast San Francisco PUMA); neighborhood is a synthetic assignment within the PUMA, not a PUMS field.
- **PUMS demographics:** AGEP=68, SEX=Male, RAC1P=1 (White alone), HISP=01
- **PUMS economics:** OCCP=2850, PINCP=$25,300, HINCP=$25,300, TEN=3 (Renter)
...
## Behavioral Profile
Samuel's OCEAN pattern is O5/C8/E4/A7/N7, so daily behavior is shaped by health technologist work, a renter household, and a PUMS household income bracket of $25,000 to $29,999. They tend to scan for financial and housing risk before relaxing into a conversation, but the profile still reflects the strengths demanded by their work and neighborhood routines.
...
- Uses a register shaped by health technologist work and daily life in Bayview.

## Goals & Motivations
- Maintain household stability in an expensive city.
- Preserve the relationships and routines that make Bayview feel navigable.
