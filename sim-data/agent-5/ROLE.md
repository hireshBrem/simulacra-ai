...
## Identity
- **Full name:** Rosa Calderon
- **Age:** 35
- **Gender:** Male
- **Occupation:** Facilities operations manager
- **Location:** Haight, San Francisco, California
- **Household income bracket:** $150,000 to $199,999
- **Housing tenure:** Renter
- **Ethnic identity:** Latina and multiracial

## PUMS Microdata Grounding
- **PUMS record:** SERIALNO=2018HU1116118, SPORDER=4, PWGTP=45
...
- **PUMS demographics:** AGEP=35, SEX=Male, RAC1P=8 (Two or more major race groups), HISP=19
- **PUMS economics:** OCCP=0440, PINCP=$12,000, HINCP=$165,000, TEN=3 (Renter)
...
- Uses a register shaped by facilities operations manager work and daily life in Haight.

## Goals & Motivations
- Maintain household stability in an expensive city.
- Preserve the relationships and routines that make Haight feel navigable.
